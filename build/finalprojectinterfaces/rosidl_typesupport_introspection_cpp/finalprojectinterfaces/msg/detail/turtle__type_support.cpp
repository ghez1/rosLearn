...
{
  new (message_memory) finalprojectinterfaces::msg::Turtle(_init);
}

void Turtle_fini_function(void * message_memory)
{
  auto typed_message = static_cast<finalprojectinterfaces::msg::Turtle *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Turtle_message_member_array[3] = {
  {
    ...
    offsetof(finalprojectinterfaces::msg::Turtle, temperature),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(finalprojectinterfaces::msg::Turtle, are_motors_ready),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(finalprojectinterfaces::msg::Turtle, debug_message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Turtle_message_members = {
  ...
  "Turtle",  // message name
  3,  // number of fields
  sizeof(finalprojectinterfaces::msg::Turtle),
...
get_message_type_support_handle<finalprojectinterfaces::msg::Turtle>()
{
  return &::finalprojectinterfaces::msg::rosidl_typesupport_introspection_cpp::Turtle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, finalprojectinterfaces, msg, Turtle)() {
  return &::finalprojectinterfaces::msg::rosidl_typesupport_introspection_cpp::Turtle_message_type_support_handle;
}
