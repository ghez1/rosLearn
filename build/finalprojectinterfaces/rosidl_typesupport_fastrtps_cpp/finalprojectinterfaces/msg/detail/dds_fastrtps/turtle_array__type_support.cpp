...
#include "finalprojectinterfaces/msg/detail/turtle_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const finalprojectinterfaces::msg::TurtleArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  finalprojectinterfaces::msg::TurtleArray & ros_message)
{
  // Member: temperature
  cdr >> ros_message.temperature;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = finalprojectinterfaces::msg::TurtleArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const finalprojectinterfaces::msg::TurtleArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<finalprojectinterfaces::msg::TurtleArray *>(
    untyped_ros_message);
...
{
  return &finalprojectinterfaces::msg::typesupport_fastrtps_cpp::_TurtleArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, finalprojectinterfaces, msg, TurtleArray)() {
  return &finalprojectinterfaces::msg::typesupport_fastrtps_cpp::_TurtleArray__handle;
}
