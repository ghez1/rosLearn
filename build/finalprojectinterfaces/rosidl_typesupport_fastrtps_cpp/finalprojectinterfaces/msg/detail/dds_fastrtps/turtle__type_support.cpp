...
#include "finalprojectinterfaces/msg/detail/turtle__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = finalprojectinterfaces::msg::Turtle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const finalprojectinterfaces::msg::Turtle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<finalprojectinterfaces::msg::Turtle *>(
    untyped_ros_message);
...
{
  return &finalprojectinterfaces::msg::typesupport_fastrtps_cpp::_Turtle__handle;
}
