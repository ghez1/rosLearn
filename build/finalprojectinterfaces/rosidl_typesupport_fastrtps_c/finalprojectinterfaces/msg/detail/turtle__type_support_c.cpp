...
#include "finalprojectinterfaces/msg/detail/turtle__rosidl_typesupport_fastrtps_c.h"
...
using _Turtle__ros_msg_type = finalprojectinterfaces__msg__Turtle;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = finalprojectinterfaces__msg__Turtle;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const finalprojectinterfaces__msg__Turtle * ros_message = static_cast<const finalprojectinterfaces__msg__Turtle *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_finalprojectinterfaces__msg__Turtle(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  finalprojectinterfaces__msg__Turtle * ros_message = static_cast<finalprojectinterfaces__msg__Turtle *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_finalprojectinterfaces__msg__Turtle(cdr, ros_message);
}

static uint32_t _Turtle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_finalprojectinterfaces__msg__Turtle(
...
static size_t _Turtle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_finalprojectinterfaces__msg__Turtle(
