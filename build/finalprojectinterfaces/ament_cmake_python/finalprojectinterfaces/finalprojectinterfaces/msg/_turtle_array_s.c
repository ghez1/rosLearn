...
bool finalprojectinterfaces__msg__turtle_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("finalprojectinterfaces.msg._turtle_array.TurtleArray", full_classname_dest, 52) == 0);
  }
  finalprojectinterfaces__msg__TurtleArray * ros_message = _ros_message;
  {  // temperature
...
PyObject * finalprojectinterfaces__msg__turtle_array__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("finalprojectinterfaces.msg._turtle_array");
